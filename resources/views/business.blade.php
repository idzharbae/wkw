    ...
    <body style="background:url({{url('img/footer.png')}}) no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover;  background-size: cover;">	
        ...
        <section id="rulebook" class="image-edge" style="padding-bottom: 0px; padding-top: 10px">
            <div class="col-md-6 col-sm-4 p0 col-md-push-6 col-sm-push-8">
                <img alt="Screenshot" class="mb-xs-24" src="img/iconbisnis.png" style="height: 600px; weight: 450px">
            </div>
            <div class="container">
				...
				<li>
				  <div class="direction-l">
					<div class="flag-wrapper">
					  ...
					  <span class="time-wrapper"><span class="time" style="color:white">10 Juni – 18 Juli 2018</span></span>
					</div>
				</li>
				<li>
				  <div class="direction-r">
