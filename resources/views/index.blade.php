				...
				<div class="container">
					<div class="row mb64 mb-xs-32">
						<div class="col-sm-6 col-sm-offset-3 text-center">
							...
							<p class="lead">
								Follow us on Instagram for workout inspiration and shots from our awesome group fitness sessions.
							</p>
						</div>
					</div>
				</div>
				<div class="instafeed grid-gallery gapless mb64 mb-xs-32 relative" data-user-name="ittoday_ipb">
					<ul></ul>
				</div>
				<div class="container">
					<div class="row">
